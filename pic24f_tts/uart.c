...
// **************************
    ...
    U2MODEbits.UEN0 = 0;          // Bits8,9 TX,RX enabled, CTS,RTS not
    U2MODEbits.UEN1 = 0; 
    ...
    U2MODEbits.PDSEL1 = 0;        // Bits1,2 8bit, No Parity
    U2MODEbits.PDSEL0 = 0; 
...
// **************************
    ...
    U2STAbits.URXISEL0 = 0;       //Bits6,7 Int. on character recieved
...
void SendUART2(char in_c)
{
    ...
    /*
    char buf[20];
   	sprintf(buf, "0x%02x ", in_c);
   	SendUARTStr(buf);
   	*/
}

void RecUART2(char *out_c)
{
    while(U2STAbits.URXDA == 0);
    *out_c = U2RXREG;
}

void SendUARTStr2(char in_s[])
{
    unsigned int lp = 0;
