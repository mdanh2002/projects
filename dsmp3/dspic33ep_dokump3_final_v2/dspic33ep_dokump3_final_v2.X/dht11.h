...
// Shared pins with UART debug and with LCD RS!
#define DHT11_IN        PORTBbits.RB10
#define DHT11_DIR       TRISBbits.TRISB10
#define DHT11_OUT       LATBbits.LATB10
#define DHT11_PULLUP    CNPUBbits.CNPUB10
