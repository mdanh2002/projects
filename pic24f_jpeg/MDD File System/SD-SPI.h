...
#include "FSDefs.h"
    ...
    // Description: This macro is used to initialize a 16-bit PIC SPI module
		...
		// original: primary precaler: 1:1 secondary prescaler: 4:1
        #define   SYNC_MODE_FAST    0x3E

		// MD: primary precaler: 2:1 secondary prescaler: 4:1
		// otherwise SPI speed will be faster than supported speed on fast CPU (> 80Mhz)
