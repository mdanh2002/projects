...
// Led control macros
/*
#define mInitStatusLeds()		LATA &= 0b00000010; TRISA &= 0b00000010;
...
#define HALL_EFFECT_OUTPUT  PORTBbits.RB2
#define PIR_SENSOR_OUTPUT   PORTEbits.RE0
#define BUZZER_OUTPUT 		LATBbits.LATB5
#define BUSY_LED_OUTPUT 	LATEbits.LATE1
#define USB_LED_OUTPUT 		LATCbits.LATC2
