...
public:
  ...
  //
  bool Initialise(unsigned char *mem_in, unsigned char *ports_in);
  ...
  //   None.
  //
  void WritePort(int Address, unsigned char Value, bool isWord, bool is2ndByte);
  ...
  //
  unsigned char ReadPort(int Address, bool isWord, bool is2ndByte);
